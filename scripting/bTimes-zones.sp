...
{    
    ...
    /*WORLDSTAR*/
    RegConsoleCmdEx("sm_hideanticheats", SM_HideAC, "Toggles Anti-Cheat visibility");
    RegConsoleCmdEx("sm_showanticheats", SM_HideAC, "Toggles Anti-Cheat visibility");
    RegConsoleCmdEx("sm_hideac", SM_HideAC, "Toggles Anti-Cheat visibility");
    RegConsoleCmdEx("sm_showac", SM_HideAC, "Toggles Anti-Cheat visibility");
    /*WORLDSTAR*/
...
public Action:SM_HideAC(client, args){
    g_Setup[client][ViewAnticheats] = !g_Setup[client][ViewAnticheats];
    PrintToChat(client, "[SM] Now %s anti-cheat zones.", g_Setup[client][ViewAnticheats]?"showing":"hiding");
    return Plugin_Handled;
}
